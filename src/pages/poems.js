...
const poems = [
  // Add more poems here...
    {
      title: "Sharita",
      time: "30 JUN 2025 AT 5:18",
      summary: "Click on the image to read the poem and its translation.",
      link: "./poem_translation/sharita",
      imgKey: "sharita.jpeg",
    },
    {
      title: "Laadki",
    ...
    <li className="">
      <CardContainer className="inter-var">
        <CardBody
          ...
          <CardItem
            translateZ="50"
            className="text-xl font-bold text-neutral-600 dark:text-white whitespace-pre">
            {title}{"\t"}
            {summary !== "" && link !== "" && (
                <CardItem
                  translateZ="20"
