...
export default function AnimatedBorderTrail({
  ...
  return (
    <div
      {...props}
      className={cn("relative h-auto w-auto overflow-hidden rounded-2xl p-px", className)}
    >
      <div
        className="absolute inset-0 h-auto w-auto animate-trail"
        style={{
      ...
      <div
        className={cn(
          "relative h-full w-full overflow-hidden rounded-[15px]",
          contentClassName,
        )}
      >
        {children}
