...
export default function EkKahani() {
  return (
    <>
      <Head>
        <title>Ek Kahani | Hindi & English</title>
        <meta name="description" content="Ek Kahani - A Hindi poem with English translation side by side." />
      </Head>
      <main
